...
*/}}
{{- define "varnish-controller-router.name" }}
...
*/}}
{{- define "varnish-controller-router.fullname" }}
...
*/}}
{{- define "varnish-controller-router.chart" }}
{{- printf "%s-%s" .Chart.Name .Chart.Version | replace "+" "_" | trunc 63 | trimSuffix "-" }}
{{- end }}

{{/*
Sets up the Varnish Controller Router image and its overrides (if any)
*/}}
{{- define "varnish-controller-router.image" }}
...
*/}}
{{- define "varnish-controller-router.natsServer" }}
{{- $natsAddress := "" }}
{{- $internalNats := false }}
...
{{- define "varnish-controller-router.boolYesNo" }}
{{- if . }}yes{{ else }}no{{ end -}}
{{- end }}
...
*/}}
{{- define "varnish-controller-router.toEnv" }}
{{- $tp := kindOf .envs }}
{{- if eq $tp "string" }}
...
*/}}
{{- define "varnish-controller-router.toYamlField" }}
